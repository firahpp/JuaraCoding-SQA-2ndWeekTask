...
public class LoginTest extends BaseTest {
    ...
    //Test Case 5: Login with Empty Username and password : UJIAN WEEK 2
    ...
    //Test Case 5: Login with Empty Password : UJIAN WEEK 2

    @Test(priority = 5)
    @Parameters({"username", "emptyPassword"})
    public void loginFailedWithEmptyPassword(String username, String emptyPassword) throws InterruptedException {
      openBrowserAndNavigateTo("https://www.saucedemo.com/");
